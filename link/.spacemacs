...
before packages are loaded."
  ...
  ;; The MacOS Emacs version usually lacks sound support, but we can redefine play-sound-internal to execute the external afplay command
  ;; Code taken from https://charlbotha.com/til/fix-emacs-sound-on-macos
  ...
  ;; Set defaults for org-timer
  (setq org-timer-default-timer "25")
  (setq org-clock-sound (substitute-in-file-name "$HOME/Music/Music/Media.localized/Music/Mixkit/Sound Effects/Happy Bells.wav"))
  )
